...
<div class="human-verification-wrapper">
	<h3>LJUDSKA PROVJERA</h3>
	<p>Skoro ste gotovi! Kliknite dalje potvrdi gumb da biste dovršili ljudsku provjeru.</p>
	...
	<div id="h-v-time-left-wrapper" class="h-v-time-left-wrapper">
		<span>Ostalo ti je:</span>
		<span id="human_verification_timer_time"></span>
	</div>
	<div class="verification-button-wrapper animated bounceIn animation-delay-1000">
		<a id="verification-button" class="tkt-btn animated pulse infinite" onclick="og_load()"><span>Potvrdi</span></a>
	</div>
</div>